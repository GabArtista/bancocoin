                            ...
                            @forelse($orders as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        data-rpd="@if ($data->min_return_per_day == $data->max_return_per_day) {{ showAmount($data->min_return_per_day, 8, exceptZeros:true) }}
                                        ...
                                        data-trx="{{ $data->trx }}"><i class="las la-desktop"></i>
                                        </button>
                                    </td>
                                </tr>
                            @empty
