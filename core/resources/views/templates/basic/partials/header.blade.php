            ...
            <div class="container">
                <div class="header-menu-content">
                    <nav class="navbar navbar-expand-lg justify-content-between p-0">
                        <a class="site-logo site-title" href="{{ route('home') }}"><img alt="@lang('site-logo')"
                                src="{{ getImage('assets/images/logoIcon/logo.png') }}"></a>

                        <button aria-controls="navbarSupportedContent" aria-expanded="false"
                            aria-label="Toggle navigation" class="navbar-toggler header-button ml-auto shadow-none"
                            data-bs-target="#navbarSupportedContent" data-bs-toggle="collapse" type="button">
                            <span class="fas fa-bars"></span>
                        </button>
                        <div class="collapse navbar-collapse justify-content-lg-center" id="navbarSupportedContent">
                            <ul style="justify-content: center;align-items: center;"
                                class="navbar-nav main-menu ml-auto mr-auto">
                                ...
                                @if (!request()->routeIs('user.*') && (!auth()->user() || (!request()->routeIs('ticket.index') && !request()->routeIs('ticket.open') && !request()->routeIs('ticket.view'))))
                                    @if ($pages->count())
                                        @foreach ($pages as $item)
                                            <li><a href="{{ route('pages', ['slug' => $item->slug]) }}">{{ __($item->name) }}</a>
                                            </li>
                                        @endforeach
                                    @endif
                                    <li><a href="{{ route('plans') }}">@lang('Planos de Mineração')</a></li>
                                    <li
                                        style="display:flex; justify-content:center;border: 1px solid white;padding: 5px;border-radius: 5px;height: 35px; width:150px">
                                        <a style="padding:0px " href="{{ route('user.login') }}">GAMES <img
                                                src="{{ getImage('assets/images/game-icon.png') }}" width="22px"></a></li>
                                ...
                                @else
                                    <li class="menu_has_children"><a href="#0">@lang('Retirada')</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="{{ route('user.withdraw.history') }}">@lang('Minhas Retiradas')</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li
                                        style="display:flex; justify-content:center;border: 1px solid white;padding: 5px;border-radius: 5px;height: 35px; width:150px">
                                        <a style="padding:0px " href="{{ route('games') }}">GAMES <img
                                                src="{{ getImage('assets/images/game-icon.png') }}" width="22px"></a></li>
                                    <li class="menu_has_children"><a href="#0">@lang('Mineradora')</a>
                                        <ul class="sub-menu">
                                            <li><a href="{{ route('user.plans') }}">@lang('Comece a Minerar')</a></li>
                                            <li><a
                                                    href="{{ route('user.plans.purchased') }}">@lang('Caminhos de Mineração')</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    @if ($general->referral_system)
                                        <li class="menu_has_children"><a href="#0">@lang('Indicados')</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="{{ route('user.referral.log') }}">@lang('Bonus de Referência')</a>
                                                </li>
                                            </ul>
                                        </li>
                                    @endif
                                    ...
                                    <li class="menu_has_children"><a href="#0">@lang('Minha Conta')</a>
                                        <ul class="sub-menu">
                                            <li><a
                                                    href="{{ route('user.profile.setting') }}">@lang('Configuração de Perfil')</a>
                                            </li>
                                            ...
                                            <li><a
                                                    href="{{ route('user.payment.history') }}">@lang('Histórico de Pagamento')</a>
                                            </li>
                                ...
                                <li class="d-flex justify-content-between d-lg-none d-block flex-wrap">
                                    ...
                                    @auth
                                        <div class="dashboard-btn d-lg-none d-block">
                                            <a class="cmn-btn"
                                                href="{{ route('user.home') }}">@lang('Escritório das Máquinas')</a>
                            ...
                            <div class="header-action">
                                ...
                                @else
                                    <a class="cmn-btn-active"
                                        href="{{ route('user.home') }}">@lang('Monitor de Mineração')</a>
                                @endguest
                            </div>
                        </div>
                    </nav>
