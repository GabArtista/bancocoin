                        ...
                        <table class="table--light style--two custom-data-table table">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('Imagem')</th>
                                    <th>@lang('Nome')</th>
                                    <th>@lang('Código da Moeda')</th>
                                    <th>@lang('Planos')</th>
                                    <th>@lang('Limite de Retirada')</th>
                                    <th>@lang('Ação')</th>
                                </tr>
                            </thead>
                            <tbody class="list">
                                @forelse($miners as $miner)
                                    ...
                                    <tr>
                                        ...
                                        <td> {{ showAmount($miner->min_withdraw_limit, 8 , exceptZeros:true) }} - {{ showAmount($miner->max_withdraw_limit, 8, exceptZeros:true) }} {{ $miner->coin_code }}</td>
                                        <td>
                ...
                <form action="{{ route('admin.miner.store') }}" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="d-flex justify-content-center">
                                    <div class="form-group">
                                        <label class="required">@lang('Imagem')</label>
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <label>@lang('Nome da Mineradora')</label>
                                ...
                                <div class="form-group">
                                    <label>@lang('Minimum Retirada')</label>
                                ...
                                <div class="form-group">
                                    <label>@lang('Maximum Retirada')</label>
                                    <div class="input-group">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn--primary w-100 h-45" type="submit">@lang('Enviar')</button>
                    </div>
                </form>
            </div>
        </div>
...
@push('breadcrumb-plugins')
    <button class="btn btn-outline--primary h-45 cuModalBtn" data-modal_title="@lang('Add Miner')" type="button">
        <i class="las la-plus"></i>@lang('Add Novo')
    </button>
