                        ...
                        <table class="table--light style--two custom-data-table table">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('Order ID')</th>
                                    <th>@lang('Plano')</th>
                                    <th>@lang('Mineradora')</th>
                                    <th>@lang('Preço')</th>
                                    <th>@lang('Periodo')</th>
                                    <th>@lang('Retorno /Diário')</th>
                                    <th>@lang('Status')</th>
                                    <th>@lang('Action')</th>
                                </tr>
                            </thead>
                            <tbody class="list">
                                @forelse($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            {{ showAmount($order->min_return_per_day, 8, exceptZeros:true) }} - {{ showAmount($order->max_return_per_day, 8, exceptZeros:true) }} <strong>{{ $order->miner->coin_code }}</strong>
                                        </td>
                                        <td>
                                            @php
