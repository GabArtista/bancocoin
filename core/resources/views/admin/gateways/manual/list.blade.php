                                        ...
                                        <td>
                                            <div class="button--group">
                                                ...
                                                @if ($gateway->status == Status::DISABLE)
                                                    <button class="btn btn-sm btn-outline--success confirmationBtn" data-question="@lang('Você realmente quer abilitar este gateway?')" data-action="{{ route('admin.gateway.manual.status', $gateway->id) }}">
                                                        <i class="la la-eye"></i> @lang('Enable')
                                                    </button>
                                                @else
                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn" data-question="@lang('Você realmente quer desabilitar este gateway?')" data-action="{{ route('admin.gateway.manual.status', $gateway->id) }}">
