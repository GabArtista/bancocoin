...
class ManageUsersController extends Controller {
    ...
    public function detail($id) {
        ...
        $totalPayment = Deposit::where('user_id', $user->id)->where('status', Status::PAYMENT_SUCCESS)->sum('amount');
        ...
        return view('admin.users.detail', compact('pageTitle', 'user', 'totalPayment', 'totalWithdrawals', 'totalTransaction', 'countries'));
    }
