...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function () {
        ...
        Route::get('get_chart_data', 'getChartData')->name('get_chart_data');
    ...
    Route::name('setting.')->prefix('setting')->group(function () {
        Route::controller('GeneralSettingController')->group(function () {
            ...
            //configuration
            Route::get('system-configuration', 'systemConfiguration')->name('system.configuration');
            Route::post('system-configuration', 'systemConfigurationSubmit');

            // Logo-Icon
            Route::get('logo-icon', 'logoIcon')->name('logo.icon');
            Route::post('logo-icon', 'logoIconUpdate')->name('logo.icon');
